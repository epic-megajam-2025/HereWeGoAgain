...
#include "EnvQueryGenerator_SimpleGridRelativeTo.h"
...
void UEnvQueryGenerator_SimpleGridRelativeTo::GenerateItems(FEnvQueryInstance& QueryInstance) const
{
	...
	{
		UE_VLOG(BindOwner, LogAI, Error, TEXT("UEnvQueryGenerator_SimpleGridRelativeTo::GenerateItems - no context items (or more than 1)"));
		return;
	}
