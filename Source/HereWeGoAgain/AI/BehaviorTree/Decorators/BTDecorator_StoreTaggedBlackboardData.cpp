#include "BTDecorator_StoreTaggedBlackboardData.h"
...
void UBTDecorator_StoreTaggedBlackboardData::StoreData(const UBlackboardComponent* Blackboard,
	UNpcComponent* NpcComponent, FBTMemory_StoreTaggedBlackboardData* BTMemory)
{
...
void UBTDecorator_StoreTaggedBlackboardData::OnNodeActivation(FBehaviorTreeSearchData& SearchData)
{
	...
	auto NpcComponent = SearchData.OwnerComp.GetAIOwner()->FindComponentByClass<UNpcComponent>();
