...
#include "AI/Interfaces/BehaviorEvaluator.h"
...
void UNpcBehaviorEvaluatorComponent::Initialize(UBehaviorTreeComponent* InBTComponent, const UNpcBlackboardKeysDataAsset* InBlackboardKeys)
{
	BTComponent = InBTComponent;
	BlackboardKeys = InBlackboardKeys;
}
